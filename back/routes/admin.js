...
router.get('/getNoticeSear', function(req, res){
    admin.getNoticeSear(req, res)
})
router.post('/addTeacher', function (req, res) {
  admin.addTeacher(req, res)
})

router.post('/addStudent', function (rep, res) {
  admin.addStudent(rep, res)
})

router.post('/deleteClass', function (req, res) {
  admin.deleteClass(req, res)
})

router.post('/updateClass', function (req, res) {
  admin.updateClass(req, res)
})
